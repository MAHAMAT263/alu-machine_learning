...
class Dataset:
    ...
    def tokenize_dataset(self, data):
        ...
        Args:
            data: tf.data.Dataset with (pt, en) sentence pairs
        Returns:
    ...
    def encode(self, pt, en):
        '''
        Encodes Portuguese and English sentences into subword tokens
        Args:
            pt: tf.Tensor of Portuguese sentence
            en: tf.Tensor of English sentence
        Returns:
            pt_tokens: np.ndarray of Portuguese token IDs
            en_tokens: np.ndarray of English token IDs
        '''
